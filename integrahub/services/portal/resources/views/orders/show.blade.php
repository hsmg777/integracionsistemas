  ...
  <style>
    ...
    @media (prefers-color-scheme: dark){
      :root{
        ...
        --warnBg: rgba(245,158,11,.2);
        --badBg: rgba(239,68,68,.2);
    ...
    *{ box-sizing:border-box; }
    ...
    .title{ margin:0; font-size: 30px; font-weight: 800; letter-spacing: -.02em; }
